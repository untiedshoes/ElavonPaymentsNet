...
- `IElavonTransactionService.ReconcileUnknownCreateOutcomeAsync` — deterministic resolution path for unknown POST outcomes (e.g. after a transport failure on `CreateTransactionAsync`).
